...
class LocationConflictResolver @Inject constructor(
    ...
    suspend fun resolveConflict(
        ...
        candidates.forEach { c ->
            Log.d(TAG, "  - ${c.label} (radius: ${c.radiusMeters}m)")
        }
        ...
        Log.d(TAG, "📐 Step 1: Area Priority")
        Log.d(TAG, "  Min radius: ${minRadius}m")
        ...
        Log.d(TAG, "  Time since: ${timeSinceActivation}s")
    ...
    fun recordActivation(locationId: String) {
        ...
        Log.d(TAG, "📝 Recorded activation: $locationId")
    }
...
- [ ] NonLocationScheduleManager 클래스 생성 (~250줄)

### 4.2 백그라운드 엔진 통합 (Day 17)
