...
- [ ] **2.2** 엠비언트 효과 구현
  - 시간이 흐름(progress)에 따라 Orb의 색상 변경 (Blue -> Purple -> Red)
...
#### 작업후처리
- [ ] 작업결과서 작성: `working_history/version_2.0/02_TimerStyleMinimalFlux구현_2025-12-12.md`
...
#### 작업
- [ ] **3.1** `TimerStyleGlassSector.kt` 생성
  - 배경 디스크(시계 눈금) 그리기
...
#### 작업후처리
- [ ] 작업결과서 작성: `working_history/version_2.0/03_TimerStyleGlassSector구현_2025-12-13.md`
...
#### 작업후처리
- [ ] 작업결과서 작성: `working_history/version_2.0/04_TimerUI마무리_2025-12-13.md`
...
|---|---|---|---|---|---|
| 1 | Pager 도입 및 UI 리팩토링 | ⬜ 대기 | - | - | - |
| 2 | Type B (Minimal Flux) 구현 | ⬜ 대기 | - | - | - |
| 3 | Type C (Glass Sector) 구현 | ⬜ 대기 | - | - | - |
| 4 | 상태 저장 및 마무리 | ⬜ 대기 | - | - | - |
