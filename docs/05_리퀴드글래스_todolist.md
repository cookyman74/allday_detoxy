...
#### 작업후처리
- [ ] 작업결과서 작성: `working_history/version_2.0/03_Glass네비게이션구현_2025-12-11.md`
- [ ] 기록할 내용:
  - 변경 전후 비교 스크린샷
...
#### 작업
- [ ] **4.1** `TimerScreen` 배경 교체
  - 단색 배경 → Mesh Gradient
- [ ] **4.2** 대시보드 카드 (`TimerCard` 등) Glass 적용
  - `liquidGlass` modifier 적용
  - 텍스트 가독성을 위한 명도 조절
- [ ] **4.3** `ScheduleGroupScreen` 리스트 아이템 Glass 적용
  - 리스트 스크롤 시 성능 확인 (렉이 걸리지 않는지)

#### 작업후처리
- [ ] 작업결과서 작성: `working_history/version_2.0/04_주요화면Glass적용_2025-12-11.md`
- [ ] 기록할 내용:
  - 주요 화면 스크린샷
  - 리스트 렌더링 성능 이슈 유무
