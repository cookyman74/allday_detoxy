 ...
 * 같은 요일의 AM/PM 행은 UI에서 붙어서 표시되고, 다른 요일 사이에는 구분선이 추가됩니다.
 *
 ...
 * 청록색(Teal) 계열로 카드 배경과 조화롭게 디자인되었습니다.
 *
 * | Duration | 기호 | 색상 (HEX) | 의미 |
 * |----------|------|-----------|------|
 * | 0분 | ▢ | #E0F2F1 | 계획 없음 (Teal 50) |
 * | 1~15분 | ░ | #80CBC4 | 가벼운 집중 (Teal 200) |
 * | 16~30분 | ▒ | #26A69A | 중간 집중 (Teal 400) |
 * | 31~45분 | ▓ | #00897B | 높은 집중 (Teal 600) |
 * | 46~60분 | █ | #004D40 | 최대 집중 (Teal 900) |
 */
enum class HeatmapLevel(val minMinutes: Int, val colorHex: String) {
    NONE(0, "#E0F2F1"),     // Teal 50 - 매우 연한 청록
    LIGHT(1, "#80CBC4"),    // Teal 200 - 연한 청록
    MEDIUM(16, "#26A69A"),  // Teal 400 - 중간 청록
    HIGH(31, "#00897B"),    // Teal 600 - 진한 청록
    MAX(46, "#004D40");     // Teal 900 - 매우 진한 청록
